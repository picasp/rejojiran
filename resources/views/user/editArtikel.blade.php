            ...
            <div class="card border-0 shadow-sm rounded">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/user/myartikel">Artikel Saya</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Artikel</li>
                    </ol>
                </nav>
                <h3>Edit Artikel</h3>
                <form action="{{ route('user.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <a href="{{ URL('/myartikel') }}" class="btn btn-danger">Batal</a>
                    </div>
